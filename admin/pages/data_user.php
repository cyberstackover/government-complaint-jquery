    ...
    <br>
		...
		<tbody>
		  ...
		  <tr>
		    ...
		    <?php if (isset($_SESSION['username'])): ?>
		    <!-- <td>
		    	<a class="btn btn-success" href="edit.php?edit=<?php echo $_GET['page']; ?>&id=<?php echo $q['memberID']; ?>">Edit</a>
		    	<a class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus.php?hapus=<?php echo $_GET['page']; ?>&id=<?php echo $q['memberID']; ?>">Hapus</a>
		    </td> -->
			<?php endif; ?>
		  </tr>
		  <?php
