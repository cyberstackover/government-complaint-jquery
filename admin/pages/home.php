...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var bar_data = {
          data: [["Data User", <?php echo mysql_num_rows($data_user); ?>], ["Data Pembelian", <?php echo mysql_num_rows($data_pembelian); ?>], ["Data Admin", <?php echo mysql_num_rows($data_teknisi); ?>], ["Data Trip", <?php echo mysql_num_rows($data_spk); ?>]],
          color: "#00A3CB"
        };
        ...
        var donutData = [
          ...
          {label: "Data Trip", data: <?php echo mysql_num_rows($data_spk); ?>, color: "#DD4B39"}
        ];
