	...
	<?php endif; ?>
		...
		<tbody>
		  ...
		  <tr>
			...
			<td><?php echo $q['item']?></td>
			<td><?php echo $q['itemDesc']?></td>
		    <td><?php echo $q['itemCategory']?></td>
			<td><?php echo $q['cityRequest'] ?>, <?php echo $q['countryRequest'] ?></td>
			<td><?php echo $q['cityDeal'] ?>, <?php echo $q['countryDeal'] ?></td>
			<td><?php echo $q['pay']?></td>
