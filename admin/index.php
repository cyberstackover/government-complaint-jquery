...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Nitip App - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Nitip </b>App</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_teknisi") { echo "active"; } ?>">
              <a href="./?page=data_teknisi">
                <i class="fa fa-group"></i> <span>Data Administrator</span> 
              </a>
            </li>
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="spk") { echo "active"; } ?>">
              <a href="./?page=spk">
                <i class="fa fa-file"></i> <span>Data Trip</span> 
              </a>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Nitip App</a></strong>
      </footer>
    </div><!-- ./wrapper -->
